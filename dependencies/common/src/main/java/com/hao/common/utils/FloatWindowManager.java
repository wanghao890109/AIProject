...
import com.hao.common.utils.romUtil.HuaweiUtils;
import com.hao.common.utils.romUtil.MeizuUtils;
import com.hao.common.utils.romUtil.MiuiUtils;
import com.hao.common.utils.romUtil.OppoUtils;
import com.hao.common.utils.romUtil.QikuUtils;
import com.hao.common.utils.romUtil.RomUtils;
import com.hao.common.utils.romUtil.HuaweiUtils;
import com.hao.common.utils.romUtil.MeizuUtils;
import com.hao.common.utils.romUtil.MiuiUtils;
import com.hao.common.utils.romUtil.OppoUtils;
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    try {
                        ...
                        ToastUtils.showShort("自动开启失效，请在应用管理中手动开启悬浮窗权限");
                    }
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    try {
                        ...
                        Log.e(TAG, "ROM:meizu, user manually refuse OVERLAY_PERMISSION", e);
                        ToastUtils.showShort("自动开启失效，请在应用管理中手动开启悬浮窗权限");
                    }
