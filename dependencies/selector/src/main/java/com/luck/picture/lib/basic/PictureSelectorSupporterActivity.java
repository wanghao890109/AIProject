...
public class PictureSelectorSupporterActivity extends AppCompatActivity {
    ...
    public static PictureSelectorSupporterActivity instance;
    ...
    protected void attachBaseContext(Context newBase) {
        super.attachBaseContext(PictureContextWrapper.wrap(newBase, PictureSelectionConfig.getInstance().language, PictureSelectionConfig.getInstance().defaultLanguage));
    }
