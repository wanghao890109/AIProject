...
public interface CompressFileEngine {
     ...
     * @param source
     */
    void onStartImageCompress(Context context, ArrayList<Uri> source, OnKeyValueResultCallbackListener call);

    void onStartVideoCompress(Context context, ArrayList<String> filePath, OnKeyValueResultCallbackListener call);
}
