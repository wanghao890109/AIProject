package com.hao.statemanager.loader;
...
public class StateRepository implements StateLoader {
     ...
     * 用于映射State和具体State对象
     */
    private HashMap<String, IState> stateMap = new HashMap<String, IState>(5);
    private static final HashMap<String, Class> stateClazzMap = new HashMap<String, Class>(5);
