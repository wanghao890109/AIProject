...
import com.hao.ui.base.BaseRecyclerListAdapter;
...
public abstract class RecyclerListAdapter<T, VH extends RecyclerListAdapter.ViewHolder<T>> extends BaseRecyclerListAdapter<T, VH> {
    ...
    public VH onCreateViewHolder(ViewGroup parent) {
        LogUtil.e("sangxiang onCreateViewHolder(ViewGroup, int) is not implemented.", new Throwable());
        String error = Log.getStackTraceString(new Throwable());
      //  Analytics.getInstance().onThrowable(new Throwable(error));
