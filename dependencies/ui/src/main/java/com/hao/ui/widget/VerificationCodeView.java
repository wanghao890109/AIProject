...
import com.hao.ui.utils.TtfUtils;
import com.hao.ui.utils.TtfUtils;
import com.hao.ui.R;
import com.hao.ui.utils.TtfUtils;
import com.hao.ui.widget.AsteriskPasswordTransformationMethod;

import java.lang.reflect.Field;

/**
 * modify Li 2022/10/26
 */
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public VerificationCodeView(Context context, AttributeSet attrs) {
        ...
        int typeFace = typedArray.getInt(R.styleable.vericationCodeView_vcv_et_typeface, VCTypeFace.NORMAL.ordinal());
        mTypeFace = VCTypeFace.values()[typeFace];
        ...
        mEtTextBg = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_bg, R.drawable.selector_code_input_et);
        mCursorDrawable = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_cursor, R.drawable.selector_code_input_et);
    ...
    private void initEditText(EditText editText, int i) {
        ...
        if (mTypeFace == VCTypeFace.FUTURA) {
            editText.setTypeface(TtfUtils.getInstance().getFuturaFont(mContext));
        }
