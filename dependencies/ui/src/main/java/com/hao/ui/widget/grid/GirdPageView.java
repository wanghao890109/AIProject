...
public class GirdPageView extends RelativeLayout {
    ...
    public GirdPageView(Context context) {
        this(context, null);
    }

    public GirdPageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.grid_item_page, this);
